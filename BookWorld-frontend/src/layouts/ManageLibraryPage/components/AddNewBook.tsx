                        ...
                        <div className='row'>
                            ...
                            <div className='col-md-3 mb-3'>
                                ...
                                <ul id='addNewBookId' className='dropdown-menu' aria-labelledby='dropdownMenuButton1'>
                                    <li><a onClick={() => setCategory('Technology')} className='dropdown-item'>Technology</a></li>
                                    <li><a onClick={() => setCategory('Fiction')} className='dropdown-item'>Fiction</a></li>
                                    <li><a onClick={() => setCategory('Marketing')} className='dropdown-item'>Marketing</a></li>
                                    <li><a onClick={() => setCategory('Reference')} className='dropdown-item'>Reference</a></li>
                                    <li><a onClick={() => setCategory('Music')} className='dropdown-item'>Music</a></li>
                                </ul>
                            </div>
                        </div>
