...
export const ChangeQuantityOfBook: React.FC<{ book: BookModel, deleteBook: any }> = (props, key) => {
    ...
    async function increaseQuantity() {
        ...
        // Instead of calling useEffect and URL again to fetch the quantities after changing, we physically change them in the frontend, so that we don't need to fetch all books' quantities again
