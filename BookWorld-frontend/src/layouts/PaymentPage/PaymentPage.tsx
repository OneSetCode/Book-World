...
export const PaymentPage = () => {
    ...
    const [nonExistPayment, setNonExistPayment] = useState(false);
    ...
    return (
        <div className='container'>
            {nonExistPayment === true ?
                <div className='mt-5'>
                    <h5 style={{ marginBottom: '25px' }}>No payment created before checking out books</h5>
                ...
                :
                <>
                    {fees > 0 && <div className='card mt-5'>
                    ...
                    {fees === 0 &&
                        <div className='mt-5'>
                            <h5 style={{ marginBottom: '25px' }}>You have no fees currently, or return books first.</h5>
                            <Link type='button' className='btn main-color text-white' to='search'>
                                Explore top books
                            </Link>
                        </div>
