...
import com.onesetcode.springbootlibrary.dao.MessageRepository;
...
public class MessagesService {
    ...
    // These two steps above allow the following steps to use MessageRepository dependency from outside the class
